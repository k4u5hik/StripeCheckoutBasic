...
// Stripe Public key
var stripe = Stripe("pk_test_u6CRDCSjfMViC6TcciX8kWTK006ForCuwz");
...
async function buttonClick(event) {
  ...
  // 
  const API_URL = "https://stripe-checkout-server.k4u5hik.repl.co";
    // const API_URL = "http://localhost:4242"; // localhost
